conn = new Mongo();
db = conn.getDB("mydatabase") // See https://www.mongodb.com/docs/manual/reference/method/Mongo.getDB/
...
db.POIs.insertOne(poi.features[0])
db.POIs.insertOne(poi.features[1])
db.POIs.insertOne(poi.features[2])
db.POIs.insertOne(poi.features[3])
db.POIs.insertOne(poi.features[4])
db.POIs.insertOne(poi.features[5])
db.POIs.insertOne(poi.features[6])
db.POIs.insertOne(poi.features[7])
db.POIs.insertOne(poi.features[8])
db.POIs.insertOne(poi.features[9])
db.POIs.insertOne(poi.features[10])
db.POIs.insertOne(poi.features[11])
db.POIs.insertOne(poi.features[12])
db.POIs.insertOne(poi.features[13])
db.POIs.insertOne(poi.features[14])
db.POIs.insertOne(poi.features[15])
